...
module.exports = (routes) => {
    ...
    routes.post('/solicitacoesDeExame', authorizeByRole([Roles.MEDICO]), solicitacoesDeExame.create);
    ...
    routes.put('/solicitacoesDeExame/resultado/:solicitacaoDeExameId', authorizeByRole([Roles.MEDICO]), solicitacoesDeExame.saveExamResult);
